...
public class Board {
    ...
    Board(int size) {
        ...
        matrix[(size/2)-1][(size/2)-1]=new Disc(0,(size/2)-1,(size/2)-1);
        matrix[(size/2)][(size/2)]=new Disc(0,(size/2),(size/2));
        matrix[(size/2)-1][(size/2)-1]=new Disc(1,(size/2)-1,(size/2)-1);
        matrix[(size/2)][(size/2)]=new Disc(1,(size/2),(size/2));
    }
